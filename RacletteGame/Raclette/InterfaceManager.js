...
define(["Raclette/pageManager", "game/images.js", "Raclette/AnimationManager"], function(pageManager, images, animationManager)
{	
	function InterfaceManager()
	{
		...
		*/
		...
		this.displayImg = function (object)
		{
			...
			var img = this.animationManager.getAnim(object.img).img;
