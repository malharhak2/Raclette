define(["Game/Map", "Game/Player", "Game/config", "Game/scrolling"], function(map, Player, config, scrolling){
	...
	function init(LajiliEngine)
	{
		...
		moteur.world.createPhysicalObjectType({id: "player", shape: "square", image: "handshroomWhite", width: 0.25, height: 0.16, density: 0.1, friction: 0, restitution: 0.2, imageWidth: 0.4, imageHeight: 0.2, imageOffset: {x:0, y: 0.05}, fixedRotation: true, animated: true});
